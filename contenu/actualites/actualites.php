        ...
        <div id="contenu_actualites">
            <div id="les_actualites">
                <div id="titreactualite">
                    <h3>Mario Kart devient réalité : "Super Nintendo
                        World" ouvrira en février 2021 !
                    </h3>
                </div>
                <div id="article_actualite">
                    <div id="datearticle_actualite">
                        <p>
                            14 janvier 2021, 14h19 par Coline
                        </p>
                    </div>
                    <div id="contenuarticle_actualites">
                        <div id="imgarticle">
                            <img src="../../images/imageArticle1.jpg">
                        </div>
